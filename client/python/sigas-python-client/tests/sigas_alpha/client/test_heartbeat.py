...
from hamcrest import assert_that, contains_exactly, is_, greater_than_or_equal_to
...
class TestHeartBeat(unittest.TestCase):
    ...
    def test_setup_game_and_sending_and_receiving_messages(self) -> None:
        ...
        assert_that(cast(Sequence, self.player1_client.messages), contains_exactly(), f"Got {self.player1_client.messages}")
